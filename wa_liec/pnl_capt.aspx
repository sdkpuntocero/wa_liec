                                    ...
                                    <div class="panel panel-default" id="pnl_clte" runat="server" visible="false">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <asp:GridView CssClass="table" ID="gv_clte" runat="server" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" TabIndex="6" OnPageIndexChanging="gv_clte_PageIndexChanging" OnRowDataBound="gv_clte_RowDataBound">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group text-left">
                                                        ...
                                                        <asp:TextBox CssClass="form-control input-box" ID="txt_municipio_clte" runat="server" placeholder="letras/números" Enabled="false" BackColor="LightGray" TabIndex="15"></asp:TextBox>
                                                        <br />
                                                    </div>
                                                    <div class="form-group text-left">
                                                        ...
                                                        <asp:TextBox CssClass="form-control input-box" ID="txt_estado_clte" runat="server" placeholder="letras/números" Enabled="false" BackColor="LightGray" TabIndex="16"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-lg-10">
                                                    ...
                                                    <asp:TextBox CssClass="form-control input-box" ID="txt_clte_coment" runat="server" placeholder="letras/números" TextMode="MultiLine" Enabled="false" BackColor="LightGray" ForeColor="#104D8D" TabIndex="17"></asp:TextBox>
                                                    <div class="text-right">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <br />
                                                    <div class="text-right">
                                                        <asp:Button CssClass="btn btn02" ID="btn_guardar_clte" runat="server" Text="GUARDAR" OnClick="btn_guardar_clte_Click" TabIndex="18" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
